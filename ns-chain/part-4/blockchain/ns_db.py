...
class NSDb:
    ...
    def write_block(self, block):  # TODO: hAndle error during write
        try:
            ...
            self.logger.info("Failure to write the block to database")
    ...
    def read_block(self, key):   
        try:
            ...
            self.logger.info("Failure to read the block from database")
    ...
    def write_last_hash(self, block):
        try:
            ...
            self.logger.info("Failure to add hash to database")
